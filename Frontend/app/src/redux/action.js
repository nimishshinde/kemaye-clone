...
export const fetchdata = () => async (dispatch) => {
  let res = await axios.get(
    "https://kimaye-nimish-bk.herokuapp.com/products/get"
  );
...
export const fetchdes = (payload) => async (dispatch) => {
  let res = await axios.get(
    `https://kimaye-nimish-bk.herokuapp.com/products/get/${payload}`
  );
...
export const fetchfilter = (payload) => async (dispatch) => {
  let res = await axios.get(
    `https://kimaye-nimish-bk.herokuapp.com/products/get/category/${payload}`
  );
...
export const incordec = (payload, count) => async (dispatch) => {
  let res = await axios.patch(
    `https://kimaye-nimish-bk.herokuapp.com/products/patch/qty?id=${payload}`,
    {
      count: count,
    }
  );
...
let res = await axios.get("https://kimaye-nimish-bk.herokuapp.com/cart/get"); 
...
export const AddToCart = (payload) => async (dispatch)=>{
  let res = await axios.post(
    `https://kimaye-nimish-bk.herokuapp.com/cart/post`,
    payload
  );
  console.log(res)
  dispatch(fetchcart())
...
let res = await axios.delete(
  `https://kimaye-nimish-bk.herokuapp.com/cart/delete/${payload}`
);
console.log(res)
dispatch(fetchcart())
}
...
let res = await axios.patch(
  `https://kimaye-nimish-bk.herokuapp.com/cart/patch/qty?id=${payload}`,
  {
    count: count,
  }
);
